...
//
// The checks are reached through `Object.values(handlers)`, so the loop variable is bound
// from a derived collection rather than from the name the attribution holds.
//
